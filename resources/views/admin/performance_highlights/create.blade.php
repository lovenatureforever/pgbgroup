...
@section('content')
<div class="container">
    <h2>Add Performance Highlight</h2>
    <form method="POST" action="{{ route('admin.performance-highlights.store') }}">
        @csrf
        <div class="mb-3">
            <label>Title</label>
        ...
        <div class="mb-3">
            ...
            <select name="pillar" class="form-control" required>
                ...
                <option value="Economic Pillar">Economic Pillar</option>
                <option value="Environmental Pillar">Environmental Pillar</option>
                <option value="Governance Pillar">Governance Pillar</option>
                <option value="Social Pillar">Social Pillar</option>
            </select>
        </div>
        <div class="mb-3">
