...
@section('content')
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <form action="{{route('admin.blogs.update', [$blog])}}" method="post" class="form-horizontal" data-parsley-validate="true" name="review-update-form" novalidate="">
                @csrf
                @method('PUT')
                <div class="form-group row mb-3">
                    <label class="col-lg-2 col-form-label form-label" for="title">Title * :</label>
                    <div class="col-lg-8">
                        <input class="form-control" type="text" id="titile" name="title" placeholder="Required" data-parsley-required="true" value="{{ old('title', isset($blog) ? $blog->title : '') }}">
                    </div>
                </div>

                <div class="form-group mb-3">
                    <label class="col-form-label form-label" for="detail">Content * :</label>
                    <div class="">
...
<script>
    ...
    $('#detail').wysihtml5();
    $('#detail').data("wysihtml5").editor.setValue(`{{ $blog->content }}`);
</script>
@endpush
