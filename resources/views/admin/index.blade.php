...
@section('content')
    ...
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Welcome to Summit Hotel Admin Panel! <small>A four star quality business hotel...</small></h1>
    <!-- END page-header -->
                    ...
                    <div class="h-300px p-3" data-scrollbar="true">
                        <div class="d-flex">
                            <a class="w-60px" href="javascript:">
                                <img src="/assets/img/user/user.png" alt="" class="mw-100 rounded-pill" />
                            </a>
